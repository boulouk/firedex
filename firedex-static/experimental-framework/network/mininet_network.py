...
class MininetNetwork:
    ...
    def execute(self, name, command):
        ...
        if name != "broker":
            ...
            while not ( line.startswith("PUBLISHER: connected.") or line.startswith("SUBSCRIBER: connected.") ):
                line = process.stdout.readline()
    ...
    def stop(self):
        for host_process in self.__host_processes:
            ...
            if name != "broker":
                line = process.stdout.readline()
                while not ( line.startswith("PUBLISHER: completed.") or line.startswith("SUBSCRIBER: completed.") ):
                    line = process.stdout.readline()
