...
class TopologyController(ControllerBase):
    ...
    def output_port_to_mac_address(self, request, **kwargs):
        topology_manager = self.parent.registory["TopologyManager"]

        request_parameters = request.json

        source_identifier = request_parameters["source_identifier"]
        destination_mac_address = request_parameters["destination_mac_address"]

        output_port = topology_manager.output_port_to_mac_address(
    ...
    def output_port_to_ip_address(self, request, **kwargs):
        ...
        source_identifier = request_parameters["source_identifier"]
        destination_ip_address = request_parameters["destination_ip_address"]
...
class TopologyApplication(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        mapper.connect(
            "Output port to mac address",
            "/api/topology/output-port-to-mac-address/",
            controller = TopologyController,
            action = "output_port_to_mac_address",
    ...
    def __host_discovery(self, host_identifier, ip_address, switch_identifier_connected_to, switch_port_connected_to):
        self.topology_manager.add_host(
            host_identifier = host_identifier
        )
