...
public class PublisherProcess {
	...
	public PublisherProcess(Publisher publisher, List<Publication> publications) {
	...
	public PublisherResult publisherResult() {
		...
		PublisherResult publisherResult = new PublisherResult(publisher.getConfiguration(), publicationsResult);
