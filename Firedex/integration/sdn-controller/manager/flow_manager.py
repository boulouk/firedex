...
class FlowManager:
    ...
    def send_flow_rules(self, switch_identifier, flow_rules):
    ...
    def send_flow_rule(self, switch_identifier, flow_rule):
        switch_datapath = self.from_switch_identifier_to_switch_datapath[switch_identifier]
        switch_datapath.send_msg(flow_rule)

    def build_flow_rule(self, switch_identifier, priority, match, actions, idle_timeout = 60, hard_timeout = 300):
        switch_datapath = self.from_switch_identifier_to_switch_datapath[switch_identifier]
