...
class TopologyController(ControllerBase):
    ...
    def output_port(self, request, source_identifier, destination_identifier, **kwargs):
        ...
        body = json.dumps(result) # jsonify
...
class TopologyApplication(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        mapper.connect(
            "Output port",
            "/api/topology/output-port/{source_identifier}/{destination_identifier}",
